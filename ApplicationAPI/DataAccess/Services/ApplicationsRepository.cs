...
namespace Application.DataAccess.Services
{
    ...
    public class ApplicationsRepository : IApplicationsRepository
    {
        ...
        public void Add(ApplicationDBModel application)
        {
        ...
        public List<ApplicationDBModel> GetAll() => _databaseContext.Applications.ToList();
        ...
        public List<ApplicationDBModel> GetAllAfterDate(DateTime date, Status status) => _databaseContext.Applications.Where(x => x.Date > date && x.Status == status).ToList();
        ...
        public ApplicationDBModel TryGetById(Guid id) => _databaseContext.Applications.FirstOrDefault(x => x.Id == id);
        ...
        public ApplicationDBModel TryGetByUserId(Guid userId) => _databaseContext.Applications.FirstOrDefault(x => x.UserId == userId);

        /// <summary>
        /// Обновляет информацию о заявке.
        /// </summary>
        /// <param name="application">Обновленная информация.</param>
        public void Update(ApplicationDBModel application)
        {
